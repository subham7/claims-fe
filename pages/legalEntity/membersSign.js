...
const validationSchema = yup.object({
    ...
    member_name: yup.string("Enter member's name").required("Member's name is required").min(3, "Member's name should be atleast 3 characters long"),
    ...
    <>
        ...
        <form className={classes.form} onSubmit={formik.handleSubmit} >
            ...
            <TextField 
                ...
                error={formik.touched.member_name && Boolean(formik.errors.member_name)}
            ...
            <TextField 
                ...
                className={classes.input} 
                InputProps={{
                endAdornment: <InputAdornment position="end">USDC
                    </InputAdornment>,
                }}
            ...
            <TextField 
                ...
                helperText={formik.touched.email && formik.errors.email} className={classes.input}  
            />
