                    ...
                    <Grid item mt={2}>
                      <Typography variant="p" className={classes.valuesStyle}>
                        ...
                        {clubAssetTokenFetched
                          ? clubAssetTokenData.totalBalance
                          : null}
                      </Typography>
                    </Grid>
                  </Grid>
            ...
            <Card className={classes.cardRegular}>
              ...
              <Stack spacing={3} ml={3}>
                ...
                <Grid container ml={3} mr={4}>
                  <Grid item>
                    <Typography variant="settingText">
                      Enable/disable withdrawals from treasury wallet
                    </Typography>
                  </Grid>
                  <Grid
                    item
                ...
                <Grid container ml={3} mr={4}>
                  <Grid item>
                    <Typography variant="settingText">
                      Minimum votes to validate a proposal
                    </Typography>
                  </Grid>
                  <Grid
                    item
                  ...
                  >
                    <Typography variant="p" className={classes.valuesStyle}>
                      {minDepositFetched ? minDeposit + "%" : null}{" "}
                      <a
                        className={classes.activityLink}
                        onClick={(e) => handleClickOpen(e)}
                      >
                ...
                <Grid container ml={3} mr={4}>
                  <Grid item>
                    <Typography variant="settingText">
                      Minimum supporting votes to pass a proposal
                    </Typography>
                  </Grid>
                  <Grid
                    item
                  ...
                  >
                    <Typography variant="p" className={classes.valuesStyle}>
                      {maxDepositFetched ? maxDeposit + "%" : null}{" "}
                      <a
                        className={classes.activityLink}
                        onClick={(e) => handleClickOpen(e)}
                      >
