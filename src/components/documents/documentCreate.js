...
import { addAdminFormData } from "redux/reducers/legal";
    ...
    <>
      <form className={classes.form} onSubmit={formik.handleSubmit}>
        ...
        <Typography className={classes.text}>
          Admin pays expenses & performs functions like reviewing member
        ...
        <Typography className={classes.text}>
          Ideal to choose a location that is convenient to visit & follow state
          laws of at the time of disputes.
        </Typography>
        ...
        <TextField
          ...
          id="general_purpose"
          value={formik.values.general_purpose}
          onChange={formik.handleChange}
          error={
            formik.touched.general_purpose &&
            Boolean(formik.errors.general_purpose)
          }
          helperText={
            formik.touched.general_purpose && formik.errors.general_purpose
          }
          className={classes.input}
        />
